...
from .views import BookRecordFormView, FormSuccessView, BookCreateView, BookUpdateView,BookDeleteView,BookDetailView

urlpatterns = [
    path("new_book_record/", 
         BookRecordFormView.as_view(), name="book_record_form"),
    path("entry_success/", 
         FormSuccessView.as_view(), name="form_success"),
