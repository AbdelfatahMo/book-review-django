...
class Development(Configuration):
    ...
    SECRET_KEY = 'django-insecure-mk^()95sa)o+o6t8x*)p5zrsab8zu0x0bjiikd&-yxhyh_+z!4'
    ...
    DATABASES = values.DatabaseURLValue('sqlite:///{}/db.sqlite3'.format(BASE_DIR),envrion_prefix="DJANGO")
    # DATABASES={
    #     'default': {
